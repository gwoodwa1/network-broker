...
- Planner/API wiring that invokes atomic task fan-out, plus a deployment entrypoint supplying qualified transport, policy, credential-broker, S3, KMS and verified workload-identity dependencies to the durable collector runtime.
